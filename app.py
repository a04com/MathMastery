...
def dashboard():
    ...
    total_geometry = 30
    return render_template('dashboard.html', username=username, algebra_solved=algebra_solved, total_algebra=total_algebra, geometry_solved=geometry_solved, total_geometry=total_geometry)
